...
public class RServlet extends HttpServlet {
    ...
    public RServlet() {
        ...
        this.message = primerchik(this.answer, 7);
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println("<a href='RR.jsp'>" + this.answer + "</a>");
        out.println("<a href='RW.jsp'>" + (this.answer - this.rnd.nextInt(10)) + "</a>");
