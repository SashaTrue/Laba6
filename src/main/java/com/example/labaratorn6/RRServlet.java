...
public class RRServlet extends HttpServlet {
    ...
    public RRServlet() {
        ...
        this.message = primerchik(this.answer, 10);
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println("<a href='RRR.jsp'>" + this.answer + "</a>");
        out.println("<a href='RRW.jsp'>" + (this.answer - this.rnd.nextInt(10)) + "</a>");
