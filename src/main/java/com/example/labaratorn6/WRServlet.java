...
public class WRServlet extends HttpServlet {
    ...
    public WRServlet() {
        ...
        this.message = primerchik(this.answer, 4);
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println("<a href='WRR.jsp'>" + this.answer + "</a>");
        out.println("<a href='WRW.jsp'>" + (this.answer - this.rnd.nextInt(10)) + "</a>");
