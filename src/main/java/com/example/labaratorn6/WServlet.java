...
public class WServlet extends HttpServlet {
    ...
    public WServlet() {
        ...
        this.message = primerchik(this.answer, 3);
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println("<a href='WR.jsp'>" + this.answer + "</a>");
        out.println("<a href='WW.jsp'>" + (this.answer - this.rnd.nextInt(10)) + "</a>");
