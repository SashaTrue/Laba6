...
public class RWServlet extends HttpServlet {
    ...
    public RWServlet() {
        ...
        this.message = primerchik(this.answer, 6);
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println("<a href='RWR.jsp'>" + this.answer + "</a>");
        out.println("<a href='RWW.jsp'>" + (this.answer - this.rnd.nextInt(10)) + "</a>");
